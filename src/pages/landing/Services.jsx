...
const Services = () => {
  ...
  return (
    <div className="services !bg-light h-[92vh]  overflow-hidden grid grid-cols-4 gap-3 ltr:pl-8 rtl:pr-8 py-8 relative ">
      <div className="Services col-span-2 mt-6">
        {/* <div className="effect absolute"></div> */}
        <h1 className="font-bold text-5xl text-purple-dark">
          {t("servicesLanding.head")}
        </h1>
        <p className="font-medium ltr:text-base rtl:text-xl text-gray">
          {t("servicesLanding.subHead")}
        </p>
        <div className="mt-6">
          <h3 className="font-bold text-4xl text-purple-dark my-3">
            {t("servicesLanding.HeadServices")}
          </h3>
          <ul className="services_list font-medium ltr:text-lg rtl:text-2xl text-gray">
            {services.map((service, index) => (
              ...
              >
                ...
                <div>
                  <h4 className="font-bold text-lg text-gray-dark inline">
                    {service.title} :
                  </h4>
                  <p className="text-gray inline"> {service.description}</p>
                </div>
              </li>
            ))}
          </ul>
